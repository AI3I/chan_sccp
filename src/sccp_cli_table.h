...
/*
 * Use it when the clearest label needs a space or other character a bare C identifier can't contain (e.g. "IP Address"); for anything that reads fine as a single word, just name the field that directly and skip it.
 */
