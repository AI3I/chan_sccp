...
static const SCCPConfigOption sccpDeviceConfigOptions[] = {
	...
	{"useRedialMenu", 		D_OBJ_REF(useRedialMenu), 		TYPE_BOOLEAN,									SCCP_CONFIG_FLAG_NONE,						SCCP_CONFIG_NOUPDATENEEDED,		"no",				"show redial phone book list instead of dialing the last number (adv_feature). Requires a Phone Service block in SEP....cnf.xml to work correctly on Java phones (see the SEP TFTP templates)\n"},
#ifdef CS_SCCP_PICKUP
