...
#define SKINNY_DISP_CALL_PROGRESS						"Call in progress"
...
#define SKINNY_DISP_NO_LINE_TO_TRANSFER						"Transfer not possible"
#define SKINNY_DISP_NO_LINE_AVAILABLE						"No line available"
#define SKINNY_DISP_NO_MORE_DIGITS						"Number too long"
#define SKINNY_DISP_NO_ACTIVE_CALL_TO_PUT_ON_HOLD				"No active call to hold"
#define SKINNY_DISP_TRANSVM_WITH_NO_CHANNEL					"No call to send to voicemail"
#define SKINNY_DISP_TRANSVM_WITH_NO_LINE					"No line to send to voicemail"
#define SKINNY_DISP_NOT_ENOUGH_CALLS_TO_TRANSFER				"Not enough calls to transfer"
#define SKINNY_DISP_MORE_THAN_TWO_CALLS						"More than 2 calls"
#define SKINNY_DISP_USE								"use"
#define SKINNY_DISP_PRIVATE_FEATURE_NOT_ACTIVE					"Privacy is not enabled"
#define SKINNY_DISP_PRIVATE_WITHOUT_LINE_CHANNEL				"No call to make private"
#define SKINNY_DISP_NO_CHANNEL_TO_PERFORM_ACTION_ON				"No call for %s"
